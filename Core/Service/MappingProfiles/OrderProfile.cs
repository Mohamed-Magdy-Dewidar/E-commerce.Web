    ...
    class OrderProfile : Profile
    {
        public OrderProfile()
        {
            ...
            CreateMap<OrderItem, OrderItemDto>()
                .ForMember(destinationMember => destinationMember.ProductId, opt => opt.MapFrom(src => src.Product.ProductId))
            ...
            CreateMap<Order, OrderToReturnDto>()
                     ...
                     .ForMember(dest => dest.shipToAddress, opt => opt.MapFrom(src => src.OrderAddress))
